- [См. первоисточник: Class Locale](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html)
...
**См. так же:** 
- [Locale.Builder](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.Builder.html), 
- [ResourceBundle](https://docs.oracle.com/javase/8/docs/api/java/util/ResourceBundle.html), 
- [Format](https://docs.oracle.com/javase/8/docs/api/java/text/Format.html), 
...
- [Serialized Form](https://docs.oracle.com/javase/8/docs/api/serialized-form.html#java.util.Locale)
...
Класс Locale реализует IETF BCP 47, который состоит из [RFC 4647 «Сопоставление языковых тегов»](https://datatracker.ietf.org/doc/html/rfc4647) и
[RFC 5646 «Теги для идентификации языков»](https://datatracker.ietf.org/doc/html/rfc5646) с поддержкой LDML (UTS № 35, «Язык разметки данных локали
...
([UNICODE_LOCALE_EXTENSION](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#UNICODE_LOCALE_EXTENSION)). Приведенный выше пример «nu-thai» становится расширением «u-nu-thai».
...
Класс Locale также предоставляет функции [getUnicodeLocaleAttributes()](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#getUnicodeLocaleAttributes--), 
[getUnicodeLocaleKeys()](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#getUnicodeLocaleKeys--) и
[getUnicodeLocaleType(java.lang.String)](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html#getUnicodeLocaleType-java.lang.String-), 
которые позволяют напрямую обращаться к атрибутам локали Unicode и парам ключ/тип. При представлении в виде строки расширение локали Unicode перечисляет
атрибуты в алфавитном порядке, за которыми следуют последовательности ключей/типов с ключами, перечисленными в алфавитном порядке (порядок вложенных тегов, 
составляющих тип ключа, фиксируется при определении типа)

- Правильно сформированный ключ локали имеет вид [0-9a-zA-Z]{2}. 
- Правильно сформированный тип локали имеет форму "" | [0-9a-zA-Z]{3,8} ('-' [0-9a-zA-Z]{3,8})* (может быть пустым или набором вложенных тегов 3-8 букв в длина).
- Правильно сформированный атрибут локали имеет форму [0-9a-zA-Z]{3,8} (это один вложенный тег с той же формой, что и вложенный тег типа локали).
...
**1. Строитель (Builder)** - Используя [Locale.Builder](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.Builder.html), вы можете создать объект Locale, соответствующий синтаксису BCP 47.
...
---
**См. более подробно в исходнике (ENG): [Class Locale](https://docs.oracle.com/javase/8/docs/api/java/util/Locale.html)**
