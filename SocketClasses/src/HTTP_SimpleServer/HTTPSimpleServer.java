...
/*
Следующие шаги выполняются при установлении TCP-соединения между двумя
компьютерами с использованием сокетов:
...
Объект класса Socket пытается подключить клиента к указанному серверу и номеру
...
Содержание запрос-ответ обмена можно посмотреть
средствами разработчика в браузере.
*/
...
public class HTTPSimpleServer {
    ...
    public static void main(String[] args) throws Throwable {
        // Создаем СерверСокет на порту 7777
        ServerSocket serverSocket = new ServerSocket(7777);
        // Бесконечный цикл
        while (true) {
            // Получаем клиента, который обратился к серверу
            Socket socketForListen = serverSocket.accept();
