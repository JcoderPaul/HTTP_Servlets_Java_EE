...
определенным в RFC2396. Вызывающая сторона несет ответственность за кодирование любых полей, которые необходимо экранировать 
перед вызовом URL, а также за декодирование любых экранированных полей, которые возвращаются из URL.
